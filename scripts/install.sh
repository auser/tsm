...
usage() {
  this=$1
  cat <<EOF
$this: download binaries for tsm
...
Usage: $this [-b bindir] [-d] [-f] [tag]
  ...
  -f forces installation, bypassing version checks
   [tag] is a tag from
   https://github.com/auser/tsm/releases
...
get_binaries() {
  case "$PLATFORM" in
    darwin/386) BINARIES="tsm" ;;
    darwin/amd64) BINARIES="tsm" ;;
    darwin/arm64) BINARIES="tsm" ;;
    darwin/armv6) BINARIES="tsm" ;;
    darwin/armv7) BINARIES="tsm" ;;
    linux/386) BINARIES="tsm" ;;
    linux/amd64) BINARIES="tsm" ;;
    linux/arm64) BINARIES="tsm" ;;
    linux/armv6) BINARIES="tsm" ;;
    linux/armv7) BINARIES="tsm" ;;
    windows/386) BINARIES="tsm" ;;
    windows/amd64) BINARIES="tsm" ;;
    windows/arm64) BINARIES="tsm" ;;
    windows/armv6) BINARIES="tsm" ;;
    windows/armv7) BINARIES="tsm" ;;
    *)
