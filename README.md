...
**Note**: The standalone binaries are built for x86_64 architecture. If you're on ARM64 (Apple Silicon, ARM servers), you may encounter compatibility issues. In that case, use the pip installation method instead.
